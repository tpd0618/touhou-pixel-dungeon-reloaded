...
public class WndKeine11 extends WndTitledMessage {

    public WndKeine11(TutorialKeine11 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine11.class, "tutorial"), message );
    }
}