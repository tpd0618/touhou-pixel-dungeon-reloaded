...
public class WndKeine4 extends WndTitledMessage {

    public WndKeine4(TutorialKeine4 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine4.class, "tutorial"), message );
    }
}