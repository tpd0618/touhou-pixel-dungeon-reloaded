...
public class WndKeine9 extends WndTitledMessage {

    public WndKeine9(TutorialKeine9 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine9.class, "tutorial"), message );
    }
}