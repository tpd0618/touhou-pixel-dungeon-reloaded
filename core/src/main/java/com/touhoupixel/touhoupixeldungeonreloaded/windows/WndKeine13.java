...
public class WndKeine13 extends WndTitledMessage {

    public WndKeine13(TutorialKeine13 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine13.class, "tutorial"), message );
    }
}