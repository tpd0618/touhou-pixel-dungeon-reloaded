...
public class WndKeine3 extends WndTitledMessage {

    public WndKeine3(TutorialKeine3 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine3.class, "tutorial"), message );
    }
}