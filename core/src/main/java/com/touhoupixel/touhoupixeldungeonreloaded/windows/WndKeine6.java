...
public class WndKeine6 extends WndTitledMessage {

    public WndKeine6(TutorialKeine6 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine6.class, "tutorial"), message );
    }
}