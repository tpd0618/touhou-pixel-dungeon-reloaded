...
public class WndKeine1 extends WndTitledMessage {

    public WndKeine1(TutorialKeine1 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine1.class, "tutorial"), message );
    }
}