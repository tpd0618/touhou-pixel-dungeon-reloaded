...
public class WndKeine12 extends WndTitledMessage {

    public WndKeine12(TutorialKeine12 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine12.class, "tutorial"), message );
    }
}