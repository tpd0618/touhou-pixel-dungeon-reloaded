...
public class WndKeine8 extends WndTitledMessage {

    public WndKeine8(TutorialKeine8 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine8.class, "tutorial"), message );
    }
}