...
public class WndKeine10 extends WndTitledMessage {

    public WndKeine10(TutorialKeine10 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine10.class, "tutorial"), message );
    }
}