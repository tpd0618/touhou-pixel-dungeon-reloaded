...
public class WndKeine2 extends WndTitledMessage {

    public WndKeine2(TutorialKeine2 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine2.class, "tutorial"), message );
    }
}