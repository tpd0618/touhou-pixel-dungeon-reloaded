...
public class WndKeine14 extends WndTitledMessage {

    public WndKeine14(TutorialKeine14 tutorialKeine, String message) {
        super( Icons.TALENT.get(), Messages.get(WndKeine14.class, "tutorial"), message );
    }
}