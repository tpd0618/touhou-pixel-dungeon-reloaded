...
public class PotionOfEnhanceFlame extends ExoticPotion {
	...
	public void apply(Hero hero) {
		identify();
		Buff.prolong( hero, FlamePower.class, FlamePower.DURATION);
		Buff.affect(hero, Burning.class).reignite(hero, 10f);
	}
}