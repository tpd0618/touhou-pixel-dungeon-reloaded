...
public class ScrollOfNewEnchantArmor extends ExoticScroll {
	
	{
		icon = ItemSpriteSheet.Icons.SCROLL_NEARMOR;
	}
	
	@Override
	public void doRead() {
		Buff.prolong(curUser, OneDefDamage.class, OneDefDamage.DURATION/10f);
		ScrollOfEnchantArmor soea = new ScrollOfEnchantArmor();
		soea.collect();
		identify();
		readAnimation();
	}
