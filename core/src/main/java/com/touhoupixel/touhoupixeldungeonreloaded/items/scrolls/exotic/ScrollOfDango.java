...
public class ScrollOfDango extends ExoticScroll {
	
	{
		icon = ItemSpriteSheet.Icons.SCROLL_DANGO;
	}
	...
	public void doRead() {
		...
		Buff.prolong(curUser, GoldCreation.class, GoldCreation.DURATION);
		Buff.prolong(curUser, KeyHeal.class, KeyHeal.DURATION);
