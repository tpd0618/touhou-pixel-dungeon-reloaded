...
public class ScrollOfRemiliaNightmare extends ExoticScroll {
	
	{
		icon = ItemSpriteSheet.Icons.SCROLL_REMILIA_NIGHT;
	}
	
	@Override
	public void doRead() {
		Buff.prolong(curUser, RemiliaFate.class, RemiliaFate.DURATION);
