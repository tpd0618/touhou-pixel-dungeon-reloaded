...
public class BuffIndicator extends Component {
	...
	public static final int HINA_CURSE  = 55;
	public static final int DOUBLE_SPEED = 56;
	...
	public static final int SUNNY_SNIPE        = 69;
	public static final int LUNA_SNIPE         = 70;
	public static final int STAR_SNIPE         = 71;
	public static final int YUUKA_RAGE         = 72;
	...
	public static final int QUAD_DAMAGE        = 77;
	public static final int STAIRS_SEAL        = 78;
	...
	public static final int HEX_CANCEL         = 114;
	public static final int FUMO_LOVER         = 115;
	public static final int ONE_MORE           = 116;
	public static final int ROULETTE_STOP      = 118;
