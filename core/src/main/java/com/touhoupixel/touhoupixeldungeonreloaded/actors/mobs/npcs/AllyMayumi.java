...
import com.touhoupixel.touhoupixeldungeonreloaded.sprites.MayumiSprite;
...
public class AllyMayumi extends NPC {
    ...
    public int attackProc( Char hero, int damage ) {
        ...
        if (!enemy.isImmune(Dread.class)) {
            Buff.affect(enemy, Dread.class).object = Dungeon.hero.id();
        } else {
            Buff.affect(enemy, Terror.class, Terror.DURATION).object = Dungeon.hero.id();
        }
        return damage;
    }
}