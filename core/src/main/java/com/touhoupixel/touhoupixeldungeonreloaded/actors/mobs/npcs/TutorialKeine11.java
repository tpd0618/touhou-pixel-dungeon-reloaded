...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine11;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine11 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine11( TutorialKeine11.this, text ) );
            }
        });
    }
}