...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine8;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine8 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine8( TutorialKeine8.this, text ) );
            }
        });
    }
}