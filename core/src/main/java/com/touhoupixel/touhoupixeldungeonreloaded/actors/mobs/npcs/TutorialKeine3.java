...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine3;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine3 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine3( TutorialKeine3.this, text ) );
            }
        });
    }
}