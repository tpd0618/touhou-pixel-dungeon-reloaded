...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine12;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine12 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine12( TutorialKeine12.this, text ) );
            }
        });
    }
}