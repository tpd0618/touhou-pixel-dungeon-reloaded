...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine9;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine9 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine9( TutorialKeine9.this, text ) );
            }
        });
    }
}