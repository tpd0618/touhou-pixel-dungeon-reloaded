...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine4;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine4 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine4( TutorialKeine4.this, text ) );
            }
        });
    }
}