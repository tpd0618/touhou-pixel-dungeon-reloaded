...
import com.touhoupixel.touhoupixeldungeonreloaded.sprites.MitamaKusiSprite;
...
public class MitamaKusi extends Mob {

    private static final float SPAWN_DELAY	= 4f;

    {
        spriteClass = MitamaKusiSprite.class;
