		...
		switch (depth) {
			...
			case 27:
				if (Statistics.extermination_number == 62) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Minoriko.class, Sannyo.class, Megumu.class, Sanae.class, Suwako.class, Kanako.class));
				} else if (Statistics.extermination_number == 63) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Shizuha.class, Sannyo.class, Megumu.class, Sanae.class, Suwako.class, Kanako.class));
				} else if (Statistics.extermination_number == 64) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Shizuha.class, Minoriko.class, Megumu.class, Sanae.class, Suwako.class, Kanako.class));
				} else if (Statistics.extermination_number == 65) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Shizuha.class, Minoriko.class, Sannyo.class, Sanae.class, Suwako.class, Kanako.class));
				} else if (Statistics.extermination_number == 66) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Shizuha.class, Minoriko.class, Sannyo.class, Megumu.class, Suwako.class, Kanako.class));
				} else if (Statistics.extermination_number == 67) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Shizuha.class, Minoriko.class, Sannyo.class, Megumu.class, Sanae.class, Kanako.class));
				} else if (Statistics.extermination_number == 68) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Shizuha.class, Minoriko.class, Sannyo.class, Megumu.class, Sanae.class, Suwako.class));
				} else return new ArrayList<>(Arrays.asList(
			...
			case 30:
				if (Statistics.extermination_number == 69) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yatsuhashi.class, Shinmyomaru.class, Seija.class, Mai.class, Satono.class, Okina.class));
				} else if (Statistics.extermination_number == 70) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Benben.class, Shinmyomaru.class, Seija.class, Mai.class, Satono.class, Okina.class));
				} else if (Statistics.extermination_number == 71) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Benben.class, Yatsuhashi.class, Seija.class, Mai.class, Satono.class, Okina.class));
				} else if (Statistics.extermination_number == 72) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Benben.class, Yatsuhashi.class, Shinmyomaru.class, Mai.class, Satono.class, Okina.class));
				} else if (Statistics.extermination_number == 73) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Benben.class, Yatsuhashi.class, Shinmyomaru.class, Seija.class, Satono.class, Okina.class));
				} else if (Statistics.extermination_number == 74) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Benben.class, Yatsuhashi.class, Shinmyomaru.class, Seija.class, Mai.class, Okina.class));
				} else if (Statistics.extermination_number == 75) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Benben.class, Yatsuhashi.class, Shinmyomaru.class, Seija.class, Mai.class, Satono.class));
				} else return new ArrayList<>(Arrays.asList(
			...
			case 32:
				if (Statistics.extermination_number == 76) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Kaguya.class, Ran.class, Youmu.class, Yuyuko.class, Satori.class, Koishi.class));
				} else if (Statistics.extermination_number == 77) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yamame.class, Ran.class, Youmu.class, Yuyuko.class, Satori.class, Koishi.class));
				} else if (Statistics.extermination_number == 78) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yamame.class, Kaguya.class, Youmu.class, Yuyuko.class, Satori.class, Koishi.class));
				} else if (Statistics.extermination_number == 79) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yamame.class, Kaguya.class, Ran.class, Yuyuko.class, Satori.class, Koishi.class));
				} else if (Statistics.extermination_number == 80) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yamame.class, Kaguya.class, Ran.class, Youmu.class, Satori.class, Koishi.class));
				} else if (Statistics.extermination_number == 81) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yamame.class, Kaguya.class, Ran.class, Youmu.class, Yuyuko.class, Koishi.class));
				} else if (Statistics.extermination_number == 82) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yamame.class, Kaguya.class, Ran.class, Youmu.class, Yuyuko.class, Satori.class));
				} else return new ArrayList<>(Arrays.asList(
			...
			case 35:
				if (Statistics.extermination_number == 83) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Suika.class, Clownpiece.class, Chimata.class, Rumia.class, Iku.class, Tenshi.class));
				} else if (Statistics.extermination_number == 84) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yuugi.class, Clownpiece.class, Chimata.class, Rumia.class, Iku.class, Tenshi.class));
				} else if (Statistics.extermination_number == 85) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yuugi.class, Suika.class, Chimata.class, Rumia.class, Iku.class, Tenshi.class));
				} else if (Statistics.extermination_number == 86) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yuugi.class, Suika.class, Clownpiece.class, Rumia.class, Iku.class, Tenshi.class));
					...
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yuugi.class, Suika.class, Clownpiece.class, Chimata.class, Rumia.class, Tenshi.class));
				} else if (Statistics.extermination_number == 89) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Yuugi.class, Suika.class, Clownpiece.class, Chimata.class, Rumia.class, Iku.class));
				} else return new ArrayList<>(Arrays.asList(
			...
			case 37:
				if (Statistics.extermination_number == 90) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Eirin.class, Doremy.class, Sagume.class, Sumireko.class, Renko.class, Junko.class));
				} else if (Statistics.extermination_number == 91) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Seiran.class, Doremy.class, Sagume.class, Sumireko.class, Renko.class, Junko.class));
				} else if (Statistics.extermination_number == 92) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Seiran.class, Eirin.class, Sagume.class, Sumireko.class, Renko.class, Junko.class));
				} else if (Statistics.extermination_number == 93) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Seiran.class, Eirin.class, Doremy.class, Sumireko.class, Renko.class, Junko.class));
				} else if (Statistics.extermination_number == 94) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Seiran.class, Eirin.class, Doremy.class, Sagume.class, Renko.class, Junko.class));
				} else if (Statistics.extermination_number == 95) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Seiran.class, Eirin.class, Doremy.class, Sagume.class, Sumireko.class, Junko.class));
				} else if (Statistics.extermination_number == 96) {
					return new ArrayList<>(Arrays.asList(
							Hecatia.class, Seiran.class, Eirin.class, Doremy.class, Sagume.class, Sumireko.class, Renko.class));
				} else return new ArrayList<>(Arrays.asList(
