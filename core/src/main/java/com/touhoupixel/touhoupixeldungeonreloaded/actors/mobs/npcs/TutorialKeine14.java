...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine14;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine14 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine14( TutorialKeine14.this, text ) );
            }
        });
    }
}