...
import com.touhoupixel.touhoupixeldungeonreloaded.windows.WndKeine13;
import com.watabou.noosa.Game;
import com.watabou.utils.Callback;

public class TutorialKeine13 extends NPC {
    ...
    private void tell( String text ) {
        Game.runOnRenderThread(new Callback() {
            @Override
            public void call() {
                GameScene.show( new WndKeine13( TutorialKeine13.this, text ) );
            }
        });
    }
}