...
import com.touhoupixel.touhoupixeldungeonreloaded.scenes.WelcomeScene;
...
public class ShatteredPixelDungeon extends Game {
	...
	public ShatteredPixelDungeon( PlatformSupport platform ) {
		...
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.actors.buffs.Bleeding.class,
				"com.shatteredpixel.shatteredpixeldungeon.levels.features.Chasm$FallBleed" );

		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.items.weapon.curses.Dazzling.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.Exhausting" );
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.items.weapon.curses.Explosive.class,
		...
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.levels.rooms.special.CrystalVaultRoom.class,
				"com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.VaultRoom" );

		//pre-v1.1.0
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.items.scrolls.exotic.ScrollOfDread.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.scrolls.exotic.ScrollOfPetrification" );
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.items.scrolls.exotic.ScrollOfSirensSong.class,
		...
		//pre-v1.0.0
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.items.stones.StoneOfFear.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.stones.StoneOfAffection" );
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeonreloaded.items.stones.StoneOfDeepSleep.class,
