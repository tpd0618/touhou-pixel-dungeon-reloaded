...
public class CardShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		itemsToSpawn.add( new MoneyBest() );
		itemsToSpawn.add( new OfferingMountain() );
		itemsToSpawn.add( new PebbleHat() );
		itemsToSpawn.add( new PhoenixTail() );
		itemsToSpawn.add( new PhysicalJizo() );
		itemsToSpawn.add( new RabbitFoot() );
		itemsToSpawn.add( new SpellBeforeFall() );
		...
		itemsToSpawn.add( new DrenchedGiantSnake() );
		itemsToSpawn.add( new DrunkGourd() );
		itemsToSpawn.add( new HundredthBlackMarket() );
		itemsToSpawn.add( new LifeBurningTorch() );
		itemsToSpawn.add( new NoProblemCreator() );
