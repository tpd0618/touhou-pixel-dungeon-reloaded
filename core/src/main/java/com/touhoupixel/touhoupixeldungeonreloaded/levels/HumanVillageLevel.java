...
public class HumanVillageLevel extends RegularLevel {
	...
	public void playLevelMusic(){
		Music.INSTANCE.playTracks(
				new String[]{Assets.Music.FLOOR_2, Assets.Music.FLOOR_2, Assets.Music.FLOOR_2},
				new float[]{1, 1, 0.5f},
				false);
	}
	...
	public void create() {
		...
		itemsToSpawn.add( Generator.random(Generator.wepTiers[2]));
		itemsToSpawn.add( Generator.random(Generator.armorTiers[2]));
		itemsToSpawn.add( Generator.random(Generator.Category.WAND));
		itemsToSpawn.add( Generator.random(Generator.misTiers[2]).quantity(3));
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(HumanVillageLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(HumanVillageLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(HumanVillageLevel.class, "bookshelf_desc");
			default:
