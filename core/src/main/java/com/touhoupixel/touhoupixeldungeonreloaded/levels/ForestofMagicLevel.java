...
public class ForestofMagicLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(ForestofMagicLevel.class, "water_name");
			case Terrain.HIGH_GRASS:
				return Messages.get(ForestofMagicLevel.class, "high_grass_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.ENTRANCE:
				return Messages.get(ForestofMagicLevel.class, "entrance_desc");
			case Terrain.EXIT:
				return Messages.get(ForestofMagicLevel.class, "exit_desc");
			case Terrain.WALL_DECO:
			case Terrain.EMPTY_DECO:
				return Messages.get(ForestofMagicLevel.class, "deco_desc");
			case Terrain.EMPTY_SP:
				return Messages.get(ForestofMagicLevel.class, "sp_desc");
			case Terrain.STATUE:
			case Terrain.STATUE_SP:
				return Messages.get(ForestofMagicLevel.class, "statue_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(ForestofMagicLevel.class, "bookshelf_desc");
			default:
