...
public class MoriyaShrineLevel extends RegularLevel {
	...
	public void playLevelMusic(){
		Music.INSTANCE.playTracks(
				new String[]{Assets.Music.FLOOR_11, Assets.Music.FLOOR_11, Assets.Music.FLOOR_11},
				new float[]{1, 1, 0.5f},
				false);
	}
	...
	public String tilesTex() {
		return Assets.Environment.TILES_11;
	}
	
	@Override
	public String waterTex() {
		return Assets.Environment.WATER_11;
	}
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(MoriyaShrineLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(MoriyaShrineLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(MoriyaShrineLevel.class, "bookshelf_desc");
			default:
