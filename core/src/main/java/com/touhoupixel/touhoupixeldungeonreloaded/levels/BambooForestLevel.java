...
public class BambooForestLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(BambooForestLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(BambooForestLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(BambooForestLevel.class, "bookshelf_desc");
			default:
