...
public class LandoftheBackDoorLevel extends RegularLevel {
	...
	public void playLevelMusic() {
		Music.INSTANCE.playTracks(
				new String[]{Assets.Music.FLOOR_14, Assets.Music.FLOOR_14, Assets.Music.FLOOR_14},
				new float[]{1, 1, 0.5f},
				false);
	}
	...
	public String tilesTex() {
		return Assets.Environment.TILES_14;
	}
	
	@Override
	public String waterTex() {
		return Assets.Environment.WATER_14;
	}
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(LandoftheBackDoorLevel.class, "water_name");
			case Terrain.HIGH_GRASS:
				return Messages.get(LandoftheBackDoorLevel.class, "high_grass_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.ENTRANCE:
				return Messages.get(LandoftheBackDoorLevel.class, "entrance_desc");
			case Terrain.EXIT:
				return Messages.get(LandoftheBackDoorLevel.class, "exit_desc");
			case Terrain.WALL_DECO:
			case Terrain.EMPTY_DECO:
				return Messages.get(LandoftheBackDoorLevel.class, "deco_desc");
			case Terrain.EMPTY_SP:
				return Messages.get(LandoftheBackDoorLevel.class, "sp_desc");
			case Terrain.STATUE:
			case Terrain.STATUE_SP:
				return Messages.get(LandoftheBackDoorLevel.class, "statue_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(LandoftheBackDoorLevel.class, "bookshelf_desc");
			default:
