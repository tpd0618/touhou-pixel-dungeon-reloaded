...
public class MyourenTempleLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(MyourenTempleLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(MyourenTempleLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(MyourenTempleLevel.class, "bookshelf_desc");
			default:
