...
public class GardenoftheSunLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(GardenoftheSunLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(GardenoftheSunLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(GardenoftheSunLevel.class, "bookshelf_desc");
			default:
