...
public class TutorialLevel extends Level {
	...
	protected void createItems() {
		...
		drop( new HomingHerb(), 758 );
		drop( new NightHerb(), 766 );
		drop( new DecoyTailsman(), 914 );
		drop( new FlandreTailsman(), 922 );
		...
		drop( new MasterHealHerb(), 1290 );
		drop( new ImpedeTailsman().quantity(5), 1292 );
		drop( new OkinaTailsman().quantity(5), 1693 );
