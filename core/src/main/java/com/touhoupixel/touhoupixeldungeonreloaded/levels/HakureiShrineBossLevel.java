...
public class HakureiShrineBossLevel extends Level {
	...
	protected boolean build() {
		...
		transitions.add(new LevelTransition(this, 93, LevelTransition.Type.REGULAR_ENTRANCE));
		transitions.add(new LevelTransition(this, 16, LevelTransition.Type.REGULAR_EXIT));
	...
	public void seal() {
		...
		set( 93, Terrain.EMPTY );
		GameScene.updateMap( 93 );

		BossLarva boss = new BossLarva();
