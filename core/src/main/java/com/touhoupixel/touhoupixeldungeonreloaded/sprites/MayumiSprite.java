...
import com.touhoupixel.touhoupixeldungeonreloaded.actors.mobs.Mayumi;
...
public class MayumiSprite extends MobSprite {

	public MayumiSprite() {
		super();

		texture( Assets.Sprites.MAYUMI );
