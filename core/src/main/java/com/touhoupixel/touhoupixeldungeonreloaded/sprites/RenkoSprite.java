...
import com.touhoupixel.touhoupixeldungeonreloaded.actors.mobs.Renko;
...
public class RenkoSprite extends MobSprite {

	public RenkoSprite() {
		super();

		texture( Assets.Sprites.RENKO );
