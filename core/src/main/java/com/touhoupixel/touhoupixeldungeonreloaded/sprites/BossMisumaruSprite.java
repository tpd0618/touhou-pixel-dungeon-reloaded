...
public class BossMisumaruSprite extends MobSprite {
	...
	public void onComplete( Animation anim ) {
		...
		if (anim == slam){
			((BossMisumaru)ch).onSlamComplete();
		}
	...
	public void link(Char ch) {
		...
		if (ch instanceof BossMisumaru && ((BossMisumaru) ch).isSupercharged()){
